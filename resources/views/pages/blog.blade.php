        ...
        <div class="row h-100 align-items-center justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="single-blog-title text-center">
                    ...
                    <div class="post-cta"><a href="single-blog.html#">travel</a></div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-lg-8">
                <div class="single-blog-content mb-100">
                    ...
                    <div class="post-meta">
                        <p><a href="single-blog.html#" class="post-author">Katy Liu</a> on <a href="single-blog.html#" class="post-date">Sep 29, 2017 at 9:48 am</a></p>
                    </div>
                    ...
                    <div class="post-content">
                        ...
                        <ul class="post-tags">
                            <li><a href="single-blog.html#">Manual</a></li>
                            <li><a href="single-blog.html#">Liberty</a></li>
                            <li><a href="single-blog.html#">Recommendations</a></li>
                            <li><a href="single-blog.html#">Interpritation</a></li>
                        </ul>
                    ...
                    <div class="sidebar-widget-area">
                        ...
                        <div class="widget-content">
                            <div class="social-area d-flex justify-content-between">
                                ...
                                <a href="single-blog.html#"><i class="fa fa-pinterest"></i></a>
                                <a href="single-blog.html#"><i class="fa fa-vimeo"></i></a>
                                <a href="single-blog.html#"><i class="fa fa-instagram"></i></a>
                                <a href="single-blog.html#"><i class="fa fa-google"></i></a>
                            </div>
                        </div>
                    </div>
...
{{--                    <form action="single-blog.html#" method="post">--}}
{{--                        <div class="row">--}}
...
{{--                                    <p><a href="single-blog.html#" class="post-author">Katy Liu</a> on <a href="single-blog.html#" class="post-date">Sep 29, 2017 at 9:48 am</a></p>--}}
{{--                                    <a href="single-blog.html#" class="comment-reply btn world-btn">Reply</a>--}}
{{--                                </div>--}}
